...
───────────────────────────────────── */
export default function GetTouch({ intouch }) {
              ...
              <div className="gt-inquiry-card">
                ...
                <div className="gt-inquiry-item">
                  ...
                  >
                    ...
                    <span className="ps-1">(818) 855-8405</span>
                  </Link>
                </div>
                <div className="gt-inquiry-item">
                  <Link href="mailto:hello@elevateaesthetics.la">
                    <span className="gt-inquiry-icon">✉</span>
                    <span className="ps-1">hello@elevateaesthetics.la</span>
                  </Link>
                </div>
              </div>
            </motion.div>
