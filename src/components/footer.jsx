...
const contactItems = [
  ...
  },
  {
    ...
    text: "(818) 855-8403",
     href : "tel:818855-8403",
  },
  {
    icon: "/images/at.png",
    text: "hello@elevateaesthetics.la",
     href : "mailto:hello@elevateaesthetics.la",
  },
];
...
function IconInstagram() {
  return <img src="/images/insta.png" alt="" />;
}

function IconFacebook() {
  return <img src="/images/facebook.png" alt="" />;
}

function IconX() {
  return <img src="/images/yelp.png" alt="" />;
}
    ...
    <div className="ft-wrapper">
      ...
      <footer className="ft-footer">
          ...
          <div className="ft-footer-grid">
            ...
            >
              ...
              <div className="ft-social-row">
                <a href="https://www.instagram.com/elevateaestheticsla/" className="ft-social-icon" aria-label="Instagram">
                  <IconInstagram />
                </a>
              ...
              <div className="ft-contact-list">
                {contactItems.map((item, i) => (
                  <div key={i} className="ft-contact-item">
                    ...
                    <Link href={item.href} target="_blank"> <span>{item.text}</span> </Link>
                  </div>
                ))}
              </div>
            </motion.div>
        ...
        <div className="ft-copyright">
          <div className="container">
            <p>© 2026 Elevate Aesthetics. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
